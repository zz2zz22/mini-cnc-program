...
namespace robot_arm_automation.Controller.PLC
{
    public class PLCConnector
    {
        ...
        public string ReadIntToString(int DbNumber, int Start)
        {
            string Result = "";
            try
            {
                ...
                Client.ReadArea(S7Area.DB, DbNumber, Start, 4, S7WordLength.Byte, buffer);
                int intValue = Sharp7.S7.GetDIntAt(buffer, 0); // Use GetDIntAt to get an integer value
